        ...
        {AI_FEATURES.map((feature, index) => {
          ...
          return (
            <motion.div
              ...
              className="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-colors"
            >
              {/* Icon */}
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-accent to-yellow-400 flex items-center justify-center mb-5">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 md:gap-8">
            {[
              ...
              <React.Fragment key={index}>
                ...
                {index < 4 && (
                  <div className="hidden md:block w-8 h-0.5 bg-gradient-to-r from-accent to-transparent" />
                )}
              </React.Fragment>
            ))}
          </div>
